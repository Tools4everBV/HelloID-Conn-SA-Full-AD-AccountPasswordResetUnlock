...
'@; 
	...
	$tmpVariables = @'
[{"name":"blnchangenextlogon","value":"{{form.blnchangenextlogon}}","secret":false,"typeConstraint":"string"},{"name":"blnunlock","value":"{{form.blnunlock}}","secret":false,"typeConstraint":"string"},{"name":"userPrincipalName","value":"{{form.gridUsers.UserPrincipalName}}","secret":false,"typeConstraint":"string"},{"name":"password","value":"{{form.password}}","secret":false,"typeConstraint":"string"},{"name":"blnreset","value":"{{form.blnreset}}","secret":false,"typeConstraint":"string"}]
'@ 
